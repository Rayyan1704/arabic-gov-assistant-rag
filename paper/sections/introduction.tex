...
Government services increasingly rely on digital platforms to serve multilingual populations. In Qatar, citizens and residents expect to access information in both Arabic and English, creating a need for effective cross-lingual information retrieval systems. Retrieval-Augmented Generation (RAG) has emerged as a powerful approach for grounding language model responses \cite{lewis2020retrieval, guu2020realm}, but its effectiveness in Arabic-English settings remains understudied.
